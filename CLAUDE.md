...
| How does the stats overlay work?              | `src/render/stats-overlay/` (orchestrator + `layoutPlan.ts`), `render/StatsOverlay.ts` barrel, `docs/api-core.md` (Stats overlay), `HardwareSettings.statsOverlayEnabled`                               |
