...
[`BT.loadingAssetsCount`](/docs/api/assets#loading-assets).
...
See [Playing music](/docs/guides/audio#playing-music) in the Audio Guide for a state-based music switching pattern and an
