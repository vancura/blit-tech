---
# Generated from blit386/docs/guide-hot-reload.md by scripts/sync-docs-from-engine.mjs.
...
outside the watched directories. See [Loading assets](/docs/api/assets#loading-assets).
