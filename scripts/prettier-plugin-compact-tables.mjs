 ...
 * every row of the table. This plugin keeps Prettier's whole Markdown printer and replaces only the `table` case with
 * a single-space layout, so a table diff touches just the lines that actually changed.
 *
